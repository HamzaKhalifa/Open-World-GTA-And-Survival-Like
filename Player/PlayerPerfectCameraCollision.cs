...
public class PlayerPerfectCameraCollision : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        rotateAround += GameManager.Instance.InputManager.Horizontal * camRotateSpeed * Time.deltaTime;
        DistanceUp = Mathf.Clamp(DistanceUp += GameManager.Instance.InputManager.Vertical, -0.79f, 2.3f);
    }
